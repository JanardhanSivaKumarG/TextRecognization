...
Project Title: Processing of Calligraphy Text to Digital Text
...
#imageFiles = os.listdir('/Users/gjsiv/Downloads/Assignments/Project/Final Code/Data/iam-handwriting-top50/data_subset/data/')
...
#        plt.show()
        ...
        try: 
            ...
            CER = "Character Error Rate: " + str(metric.CER())
            ...
            WER = "Word Error Rate: " + str(metric.WER())
